...
const View = () => {
  ...
  return (
      <div className="flex flex-wrap justify-center">
        <div className="max-w-[250px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-3">
          <a href="#">
        ...
        <div className="max-w-[250px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-3">
          ...
          <div className="p-5">
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              File Name: {`${docs[1].name}`}
            </p>
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              File Type: {`${docs[1].type}`}
            </p>
            {docs[1].encrypted ? (
              <a
                href="#"
              ...
              <a
                href="#"
                className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                onClick={() => retrieveFile(docs[1].cid, docs[1].name)}
              >
                Show
              </a>
            )}
